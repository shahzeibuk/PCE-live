...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('posts', 'news', 'gallery', 'services');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('posts', 'news', 'gallery', 'services');
  ...
  CREATE TYPE "public"."enum_footer_groups_nav_items_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE "pages_blocks_live_exchange_rates" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Live Exchange Rates',
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_currency_converter" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Currency Converter',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_whatsapp_c_t_a" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Contact Us on WhatsApp',
  	"body" varchar DEFAULT 'Need the Best Exchange Rates? Chat with us on WhatsApp for less instant updates!',
  	"button_text" varchar DEFAULT 'WhatsApp Now',
  	"phone_number" varchar DEFAULT '+920000000000',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_live_exchange_rates" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_currency_converter" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_whatsapp_c_t_a" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "footer_groups_nav_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_groups_nav_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL
  );
  ...
  ALTER TABLE "pages_blocks_live_exchange_rates" ADD CONSTRAINT "pages_blocks_live_exchange_rates_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_currency_converter" ADD CONSTRAINT "pages_blocks_currency_converter_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_whatsapp_c_t_a" ADD CONSTRAINT "pages_blocks_whatsapp_c_t_a_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_live_exchange_rates" ADD CONSTRAINT "_pages_v_blocks_live_exchange_rates_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_currency_converter" ADD CONSTRAINT "_pages_v_blocks_currency_converter_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_whatsapp_c_t_a" ADD CONSTRAINT "_pages_v_blocks_whatsapp_c_t_a_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "footer_groups_nav_items" ADD CONSTRAINT "footer_groups_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_groups"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_live_exchange_rates_order_idx" ON "pages_blocks_live_exchange_rates" USING btree ("_order");
  CREATE INDEX "pages_blocks_live_exchange_rates_parent_id_idx" ON "pages_blocks_live_exchange_rates" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_live_exchange_rates_path_idx" ON "pages_blocks_live_exchange_rates" USING btree ("_path");
  CREATE INDEX "pages_blocks_currency_converter_order_idx" ON "pages_blocks_currency_converter" USING btree ("_order");
  CREATE INDEX "pages_blocks_currency_converter_parent_id_idx" ON "pages_blocks_currency_converter" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_currency_converter_path_idx" ON "pages_blocks_currency_converter" USING btree ("_path");
  ...
  CREATE INDEX "pages_blocks_whatsapp_c_t_a_order_idx" ON "pages_blocks_whatsapp_c_t_a" USING btree ("_order");
  CREATE INDEX "pages_blocks_whatsapp_c_t_a_parent_id_idx" ON "pages_blocks_whatsapp_c_t_a" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_whatsapp_c_t_a_path_idx" ON "pages_blocks_whatsapp_c_t_a" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_live_exchange_rates_order_idx" ON "_pages_v_blocks_live_exchange_rates" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_live_exchange_rates_parent_id_idx" ON "_pages_v_blocks_live_exchange_rates" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_live_exchange_rates_path_idx" ON "_pages_v_blocks_live_exchange_rates" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_currency_converter_order_idx" ON "_pages_v_blocks_currency_converter" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_currency_converter_parent_id_idx" ON "_pages_v_blocks_currency_converter" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_currency_converter_path_idx" ON "_pages_v_blocks_currency_converter" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_whatsapp_c_t_a_order_idx" ON "_pages_v_blocks_whatsapp_c_t_a" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_whatsapp_c_t_a_parent_id_idx" ON "_pages_v_blocks_whatsapp_c_t_a" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_whatsapp_c_t_a_path_idx" ON "_pages_v_blocks_whatsapp_c_t_a" USING btree ("_path");
  ...
  CREATE UNIQUE INDEX "currency_rates_currency_code_idx" ON "currency_rates" USING btree ("currency_code");
  ...
  CREATE INDEX "footer_groups_nav_items_order_idx" ON "footer_groups_nav_items" USING btree ("_order");
  CREATE INDEX "footer_groups_nav_items_parent_id_idx" ON "footer_groups_nav_items" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_live_exchange_rates" CASCADE;
  DROP TABLE "pages_blocks_currency_converter" CASCADE;
  DROP TABLE "pages_blocks_services_grid" CASCADE;
  DROP TABLE "pages_blocks_whatsapp_c_t_a" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_live_exchange_rates" CASCADE;
  DROP TABLE "_pages_v_blocks_currency_converter" CASCADE;
  DROP TABLE "_pages_v_blocks_services_grid" CASCADE;
  DROP TABLE "_pages_v_blocks_whatsapp_c_t_a" CASCADE;
  ...
  DROP TABLE "footer_groups_nav_items" CASCADE;
  ...
  DROP TYPE "public"."enum_footer_groups_nav_items_link_type";`)
}
